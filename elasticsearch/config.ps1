...
#Paths
$jrePath = 'C:\Program Files\Java\jre1.8.0_221' #path to Java Server JRE (relative to script or absolute), point to folder containing bin directory not to bin directory itself
