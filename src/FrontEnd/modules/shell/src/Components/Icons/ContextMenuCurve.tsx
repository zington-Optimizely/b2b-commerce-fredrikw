...
const ContextMenuCurve: React.FC<{ width?: number; height?: number; color1?: string; className?: string }> = ({
    width = undefined,
    height = undefined,
    color1 = "#4A4A4A",
    className,
    ...
    return (
        ...
        >
            <path
                ...
                clipRule="evenodd"
                fill={color1}
                d="M21.8 3.5c-3.9-4.7-10.3-4.7-14.3 0L4.8 6.7S1.9 9.5 0 9.5h30.5c-1.1 0-3.9-.5-6.1-2.8l-2.6-3.2z"
            />
        </svg>
    );
};
