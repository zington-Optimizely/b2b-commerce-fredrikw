...
const Undo: React.FC<{ size?: number, color1?: string, className?: string }> = ({ size = 20, color1 = '#4A4A4A', className }) => (
...
export const UndoSrc: React.FC = () => {
    return (<svg focusable="false" viewBox="0 0 20 20" width="24" height="24">
