...
const Redo: React.FC<{ width?: number, height?: number, color1?: string, className?: string }> = ({ width = undefined, height = undefined, color1 = '#4A4A4A', className }) => {
    const { calculatedWidth, calculatedHeight } = calculateDimensions(width, height, 19, 20);
    return <svg focusable="false" className={className} viewBox="0 0 19 20" width={calculatedWidth} height={calculatedHeight}>
...
export const RedoSrc: React.FC = () => {
    return (<svg focusable="false" viewBox="0 0 19 20" width="24" height="24">
