...
const Template: React.FC = () => {
    ...
    <g transform="translate(2 1)" fill="none" fillRule="evenodd">
        ...
        <circle stroke="#4A4A4A" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" cx="14.732" cy="16.187" r="6.002"/>
        <path stroke="#4A4A4A" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" d="M14.732 13.786v4.802m-2.401-2.401h4.802"/>
    </g>
</svg>;
};
