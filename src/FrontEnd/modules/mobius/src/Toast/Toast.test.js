...
const themeGenerator = defaultProps => ({
    ...baseTheme, toast: { defaultProps, toasterProps: baseTheme.toast.toasterProps },
});
...
describe('Toast', () => {
    ...
    describe('render HTML elements', () => {
        ...
        describe('toast', () => {
            ...
            test('renders children when passed with body', () => {
                consumerChildren = buildConsumerChildren({ body: 'hat', children: (<div id="moose-man">Moose man</div>) });
                const root = wrapper();
                root.find(Button).simulate('click');
    ...
    describe('appropriately applies theme overrides', () => {
        ...
        describe('closeButtonProps', () => {
            ...
            test('theme and instance applies instance', () => {
                children = <Toast {...defaultToastProps} closeButtonProps={{ shadow: true, shape: 'rounded' }} in={true} />;
        ...
        describe('bodyTypographyProps', () => {
            ...
            test('theme and instance applies instance', () => {
                children = <Toast {...defaultToastProps} bodyTypographyProps={{ weight: 400, underline: false }} in={true} />;
