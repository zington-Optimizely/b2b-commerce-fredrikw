...
const reducer = {
    ...
    "Components/OrderUpload/CompleteBatchLoadProducts": (draft: Draft<OrderUploadState>, action: { result: BatchLoadProductsResult }) => {
    ...
    "Components/OrderUpload/CompleteProcessFile": (draft: Draft<OrderUploadState>, action: { result: ProcessFileResult; }) => {
    ...
    "Components/OrderUpload/SetAllowCancel": (draft: Draft<OrderUploadState>, action: { parameter: { allowCancel: boolean } }) => {
        draft.allowCancel = action.parameter.allowCancel;
    },
    "Components/OrderUpload/SetErrorsModalIsOpen": (draft: Draft<OrderUploadState>, action: { parameter: { errorsModalIsOpen: boolean } }) => {
        draft.errorsModalIsOpen = action.parameter.errorsModalIsOpen;
    },
    "Components/OrderUpload/SetIsBadFile": (draft: Draft<OrderUploadState>, action: { parameter: { isBadFile: boolean } }) => {
        draft.isBadFile = action.parameter.isBadFile;
    },
    "Components/OrderUpload/SetIsUploading": (draft: Draft<OrderUploadState>, action: { parameter: { isUploading: boolean } }) => {
        draft.isUploading = action.parameter.isUploading;
    },
    "Components/OrderUpload/SetUploadCancelled": (draft: Draft<OrderUploadState>, action: { parameter: { uploadCancelled: boolean } }) => {
        draft.uploadCancelled = action.parameter.uploadCancelled;
    },
    "Components/OrderUpload/SetUploadLimitExceeded": (draft: Draft<OrderUploadState>, action: { parameter: { uploadLimitExceeded: boolean } }) => {
        draft.uploadLimitExceeded = action.parameter.uploadLimitExceeded;
    },
    "Components/OrderUpload/SetContinueUpload": (draft: Draft<OrderUploadState>, action: { parameter: { continueUpload: boolean } }) => {
