...
import { UploadedItem } from "@insite/client-framework/Store/Pages/OrderUpload/OrderUploadState";
...
export const DispatchBeginProcessFile: HandlerType = props => {
    props.dispatch({
        type: "Pages/OrderUpload/BeginProcessFile",
    });
};
...
export const DispatchCompleteProcessFile: HandlerType = props => {
    props.dispatch({
        type: "Pages/OrderUpload/CompleteProcessFile",
        result: props.result,
    });
};
