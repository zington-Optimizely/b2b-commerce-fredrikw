 ...
 */
function deepFreezeObject<T extends object>(object: T, seen?: WeakSet<object>): Readonly<T>;
function deepFreezeObject<T extends object>(object: T | null | undefined, seen?: WeakSet<object>) {
    if (!object) {
