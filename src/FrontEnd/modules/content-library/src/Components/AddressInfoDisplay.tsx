        ...
        <StyledAddress {...styles.wrapper}>
            ...
            {props.attention
                && <Typography
                    ...
                    data-test-selector="addressInfoDisplay_attention"
                >
            ...
            {props.companyName
                && <Typography
                    ...
                    data-test-selector="addressInfoDisplay_companyName"
                >
                    {props.companyName}
                </Typography>
            }
            <Typography
                {...styles.address1Text}
                data-test-selector="addressInfoDisplay_address1"
            >
                {props.address1}
            </Typography>
            {props.address2
                && <Typography
                    {...styles.address2Text}
                    data-test-selector="addressInfoDisplay_address2"
                >
                    {props.address2}
                </Typography>
            }
            {props.address3
                && <Typography
                    {...styles.address3Text}
                    data-test-selector="addressInfoDisplay_address3"
                >
                    {props.address3}
                </Typography>
            }
            {props.address4
                && <Typography
                    {...styles.address4Text}
                    data-test-selector="addressInfoDisplay_address4"
                >
                    {props.address4}
                </Typography>
            }
            ...
            {props.country
                && <Typography
                    {...styles.countryText}
                    data-test-selector="addressInfoDisplay_country"
                >
                    {props.country}
                </Typography>
            }
            {props.phone
                && <Typography
                    {...styles.phoneText}
                    data-test-selector="addressInfoDisplay_phoneNumber"
                >
                    {props.phone}
                </Typography>
            }
            {props.fax
                && <Typography
                    {...styles.faxText}
                    data-test-selector="addressInfoDisplay_fax"
                >
                    {props.fax}
                </Typography>
            }
            {props.email
                && <Link
                    typographyProps={styles.emailText}
                    data-test-selector="addressInfoDisplay_emailAddress"
                >
                    {props.email}
                </Link>
            }
        ...
        <Typography {...styles.customerNameText}>
            {firstName
                && <Typography
                    ...
                    data-test-selector="addressInfoDisplay_firstName"
                >
                    {`${firstName} `}
                </Typography>
            }
            {lastName
                && <Typography
                    {...styles.lastNameText}
                    data-test-selector="addressInfoDisplay_lastName"
                >
                    {lastName}
                </Typography>
            }
...
const CityStatePostalCode = ({
    ...
    postalCode,
    styles,
}: CityStatePostalCodeProps) => {
    return (
        <Typography {...styles.cityStatePostalCodeText}>
            <Typography
                {...styles.cityText}
                data-test-selector="addressInfoDisplay_city"
            >
                {city}
            </Typography>
            {state
                && <>
                    ...
                    <Typography
                        {...styles.stateText}
                        data-test-selector="addressInfoDisplay_state"
                    >
                        {state}
                    </Typography>
                </>
            ...
            {postalCode
                && <Typography
                    ...
                    data-test-selector="addressInfoDisplay_postalCode"
                >
                    {postalCode}
                </Typography>
            }
